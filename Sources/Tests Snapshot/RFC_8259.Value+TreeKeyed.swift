...
func _jsonToKeyedTree(_ value: RFC_8259.Value) -> Tree.Keyed<Swift.String, RFC_8259.Value> {
    var tree = Tree.Keyed<Swift.String, RFC_8259.Value>()

    let rootPos = try! tree.insert(_jsonLocalValue(value), at: .root)

    var pending: [(parent: Tree.Position, key: Swift.String, value: RFC_8259.Value)] = []
...
private func _jsonAppendChildren(
    ...
    to pending: inout [(parent: Tree.Position, key: Swift.String, value: RFC_8259.Value)]
) {
    switch value {
    case .object(let obj):
